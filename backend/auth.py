import bcrypt
import psycopg2
# Kita import langsung fungsi koneksi yang udah lo benerin tadi
from backend.database.db_manager import get_db_connection

def get_user_role(username: str):
    """Fungsi babu buat ngecek kasta user."""
...
def verify_login(input_username: str, input_password: str) -> dict:
    ...
    try:
        ...
        return {"success": False, "role": None, "message": "Terjadi kesalahan internal bcrypt."}
...
def register_user(initiator_username: str, new_username: str, new_password: str, new_role: str) -> dict:
    ...
    try:
        ...
        cursor.execute("INSERT INTO users (username, password_hash, role) VALUES (%s, %s, %s)", 
                       (new_username, hash_pwd, new_role))
        conn.commit()
...
def hijack_user(initiator_username: str, target_username: str) -> dict:
    ...
    return {"success": True, "role": row[0], "message": f"Berhasil merasuki {target_username}. Ingat batas woy."}
